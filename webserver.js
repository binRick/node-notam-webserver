...
geo.addLocations(icaoLocations, function(err, reply) {
    ...
    app.get('/nearby/:nearbyType/myIP/:distance/:unit/:brief?', function(req, res) {
        var ipDat = geoip.allData(req.connection.remoteAddress);
        req.params.lat = ipDat.location.latitude;
        req.params.lng = ipDat.location.longitude;
        getLocationInfo(req, res);
    });
    app.get('/nearby/:nearbyType/:lat/:lng/:distance/:unit/:brief?', getLocationInfo);
